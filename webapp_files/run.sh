...
cat << EOF > /opt/apache-tomcat-7.0.81/conf/tomcat-users.xml
...
if [ -f "/opt/apache-tomcat-7.0.81/webapps/manager/WEB-INF/web.xml" ]
then
...
exec /opt/apache-tomcat-7.0.81/bin/catalina.sh run
